...
/*
 * @apiDefine: ToggleVerifyEmailRequestParam
 */
type ToggleVerifyEmailRequestParam struct {
	ID string `json:"id" openapi:"example:1;nullable;pattern:^[0-9]+$;in:path"`
}

func (p *ToggleVerifyEmailRequestParam) Validate(params gocriteria.Params) gocriteria.ValidityResponseErrors {
