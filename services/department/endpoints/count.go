...
func (s *service) Count(ctx context.Context, params DepartmentQueryRequestParams) (int64, response.ErrorResponse) {
	var count int64

	tx := s.db.WithContext(ctx).Model(&models.Department{})
