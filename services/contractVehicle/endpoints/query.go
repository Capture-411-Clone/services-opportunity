...
/*
 * @apiDefine: ContractVehicleQueryFilterType
 */
type ContractVehicleQueryFilterType struct {
...
/*
 * @apiDefine: ContractVehicleQueryRequestParams
 */
type ContractVehicleQueryRequestParams struct {
	...
	Filters ContractVehicleQueryFilterType `json:"filters,omitempty" openapi:"$ref:ContractVehicleQueryFilterType;in:query"`
}

func (data *ContractVehicleQueryRequestParams) ValidateQueries(r *http.Request) gocriteria.ValidityResponseErrors {
...
func makeFilters(params ContractVehicleQueryRequestParams) []string {
	var where []string
...
func (s *service) Query(
	ctx context.Context, offset, limit int, params ContractVehicleQueryRequestParams,
	...
	err := tx.Find(&contractVehicles).Error

	if err != nil {
		s.logger.With(ctx).Error(err)
		return []models.ContractVehicle{}, response.GormErrorResponse(err, "error in finding contractVehicle")
	}

	return contractVehicles, response.ErrorResponse{}
}
