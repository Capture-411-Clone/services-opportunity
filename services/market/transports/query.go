 ...
 * @apiMethod: GET
 * @apiStatusCode: 200
 * @apiParametersRef: MarketQueryRequestParams
 * @apiResponseRef: MarketQueryResponse
 * @apiSummary: get market
 * @apiDescription: get market
 * @apiSecurity: jwtBearerAuth
 */
func (r *resource) query(ctx echo.Context) error {
	var params = &endpoints.MarketQueryRequestParams{}
	...
	result := marketQueryResponseData{
		Limit:      pages.Limit(),
		Offset:     pages.Offset(),
		Page:       pages.Page,
...
/*
 * @apiDefine: marketQueryResponseData
 */
type marketQueryResponseData struct {
	Limit      int             `json:"limit" openapi:"example:20"`
	Offset     int             `json:"offset" openapi:"example:0"`
	Page       int             `json:"page" openapi:"example:1"`
	TotalRows  int64           `json:"totalRows" openapi:"example:10"`
	TotalPages int             `json:"totalPages" openapi:"example:1"`
	Items      []models.Market `json:"items" openapi:"$ref:Market;type:array;"`
}

/*
 * @apiDefine: MarketQueryResponse
 */
type MarketQueryResponse struct {
	StatusCode int                     `json:"status_code" openapi:"example:200;type:integer"`
	Data       marketQueryResponseData `json:"data" openapi:"$ref:marketQueryResponseData;type:object"`
}
